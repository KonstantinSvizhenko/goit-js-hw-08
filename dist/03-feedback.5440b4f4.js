...
info.email.addEventListener("input", (0, _lodashThrottleDefault.default)(onInput, 500));
info.textarea.addEventListener("input", (0, _lodashThrottleDefault.default)(onInput, 500));
if (savedData) {
...
function onFormSubmit(event) {
    ...
    inputData.email = input.email.value;
    inputData.message = input.message.value;
    if (input.email.value === "" || input.message.value === "") alert("Please fill up empty fields");
    else {
